...
DEFAULT_EXECUTORS = [
    ...
    ("Олексій Бука",          [
     "Олексію БУКА", "Олексію Буці", "Олексій БУКА"]),
    ...
    ("Коренкова Юлія",        ["Юлії КОРЕНКОВІЙ",
     "Юлії Коренковій", "Юлія КОРЕНКОВА"]),
    ("Леонтьєв Михайло",      ["Михайлу ЛЕОНТЬЄВУ",
     "Михайлу Леонтьєву", "Михайло ЛЕОНТЬЄВ"]),
    ("Залуський Андрій",      ["Андрію ЗАЛУСЬКОМУ",
     "Андрію Залуському", "Андрій ЗАЛУСЬКИЙ"]),
    ("Іщенко Андрій",         [
     "Андрію ІЩЕНКО", "Андрію Іщенку", "Андрій ІЩЕНКО"]),
    ("Москаленко Ніна",       ["Ніні МОСКАЛЕНКО",
     "Ніні Москаленко", "Ніна МОСКАЛЕНКО"]),
    ("Олінкевич Олег",        ["Олегу ОЛІНКЕВИЧ",
     "Олегу Олінкевичу", "Олег ОЛІНКЕВИЧ"]),
